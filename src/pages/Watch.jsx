    ...
    useEffect(() => {
        const loadVideo = async () => {
            try {
                ...
                const recData = await fetchRecommendedVideos(
                    data.snippet.title
                );
    ...
    return (
        <div className="w-full max-w-[1800px] flex gap-6 text-white">
            ...
            <div className="w-[400px] space-y-3">
                <h1 className="font-bold text-4xl">Recomended Videos</h1>
                {recommended.map((item) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium line-clamp-2 mb-1 group-hover:text-gray-300 transition-colors">
                                {item.snippet.title}
                            </p>
